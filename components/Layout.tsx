    ...
    items: [
      {
        ...
        activeIcon: (
          ...
          >
            ...
            <path
              fill-rule="evenodd"
              d="M4.5 4.5a.75.75 0 0 1 .75-.75H16.5a.75.75 0 0 1 .75.75v16.19l2.47-2.47a.75.75 0 1 1 1.06 1.06l-3.75 3.75a.75.75 0 0 1-1.06 0l-3.75-3.75a.75.75 0 1 1 1.06-1.06l2.47 2.47V5.25H6v14.25a.75.75 0 0 1-1.5 0V4.5Z"
              clip-rule="evenodd"
            />
          </svg>
        ),
      ...
      <div class="drawer-content flex flex-col bg-base-200 min-h-screen">
        ...
        <header class="bg-base-100 border-b border-base-300 px-6 py-4 sticky top-0 z-10">
          <div class="flex items-center gap-4">
            ...
            <h1 class="text-xl font-bold">{title || "Polimoney Ledger"}</h1>
          </div>
        </header>
